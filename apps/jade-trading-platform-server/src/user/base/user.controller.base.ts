...
export class UserControllerBase {
  ...
  async findJades(
    ...
    const query = plainToClass(JadeFindManyArgs, request.query);
    const results = await this.service.findJades(params.id, {
      ...query,
      select: {
        createdAt: true,
        description: true,
  ...
  async connectJades(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: JadeWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      jades: {
        connect: body,
  ...
  @common.Delete("/:id/jades")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async disconnectJades(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: JadeWhereUniqueInput[]
  ): Promise<void> {
    const data = {
